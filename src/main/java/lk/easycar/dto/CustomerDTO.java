...
public class CustomerDTO {
    ...
    public CustomerDTO(String cusID, String cusName, String cusEmail, String cusPassword, String cusNIC, String cusDrivingLicenseNo, String cusAddress, String cusContactNo) {
        this.cusID = cusID;
